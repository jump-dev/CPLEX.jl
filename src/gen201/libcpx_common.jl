...
# Skipping MacroDefinition: CPXLIBAPI __declspec ( dllimport )
# Skipping MacroDefinition: CPXDEPRECATEDAPI ( version ) __declspec ( dllimport deprecated )
# Skipping MacroDefinition: CPXDEPRECATED ( version ) __declspec ( deprecated )

const CPXDEPRECATEDENUMVAL = nothing

# Skipping MacroDefinition: CPXEXPORT __declspec ( dllexport )

const CPX_STR_PARAM_MAX = 512

# Skipping MacroDefinition: CPX_STATIC_INLINE static __inline
