...
function CPXcallbackgetfunc(env, lp, contextmask_p, callback_p, cbhandle_p)
    ccall((:CPXcallbackgetfunc, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{CPXLONG}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}), env, lp, contextmask_p, callback_p, cbhandle_p)
end
...
function CPXcallbacksetfunc(env, lp, contextmask, callback, userhandle)
    ccall((:CPXcallbacksetfunc, libcplex), Cint, (CPXENVptr, CPXLPptr, CPXLONG, Cvoid, Ptr{Cvoid}), env, lp, contextmask, callback, userhandle)
end
...
function CPXmodelasstcallbackgetfunc(env, lp, callback_p, cbhandle_p)
    ccall((:CPXmodelasstcallbackgetfunc, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}), env, lp, callback_p, cbhandle_p)
end

function CPXmodelasstcallbacksetfunc(env, lp, callback, userhandle)
    ccall((:CPXmodelasstcallbacksetfunc, libcplex), Cint, (CPXENVptr, CPXLPptr, Cvoid, Ptr{Cvoid}), env, lp, callback, userhandle)
end
