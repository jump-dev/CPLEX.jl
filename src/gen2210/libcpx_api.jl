...
function CPXcallbackgetrelaxationpi(context, lrpi, lrbeg, lrend, qrpi, qrpidef, qrbeg, qrend, qzerotol_p)
    ccall((:CPXcallbackgetrelaxationpi, libcplex), Cint, (CPXCALLBACKCONTEXTptr, Ptr{Cdouble}, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Cint, Cint, Ptr{Cdouble}), context, lrpi, lrbeg, lrend, qrpi, qrpidef, qrbeg, qrend, qzerotol_p)
end
